...
class Conctract extends LoginPage
{
   ...
   cstate2()
   {
    ...
    {
        cy.wait(3000)
      const addbtn=cy.get('#mat-radio-3 > .mat-radio-label > .mat-radio-label-content')
      addbtn.click()
    }
    ...
    {
        cy.wait(3000)
      const conname=cy.get('#mat-input-3')
      conname.type(value)
    }
    ...
    {
        cy.wait(3000)
      const conid=cy.get('#mat-input-4')
      conid.type(value)
    }
    ...
    {
        cy.wait(3000)
      const conssn=cy.get('#mat-input-5')
      conssn.type(value)
    }
    ...
    ecity(value)
    {
     ...
     estate()
     {
       ...
       ck3.click()
       cy.wait(10000)
       const ck4=cy.get('#mat-option-254 > .mat-option-text')
       ck4.click()
     }
       ezip(value)
       {
       ...
       {
          cy.wait(5000)
          const ps=cy.get('#mat-select-4 > .mat-select-trigger > .mat-select-value > .mat-select-placeholder')
          ps.click()
          cy.wait(2000)
       ...
       {
        cy.wait(3000)
        const earns=cy.get('#mat-select-5 > .mat-select-trigger > .mat-select-value')
        earns.click()

        cy.wait(3000)
        const earns2=cy.get('#mat-option-167 > .mat-option-text')
        earns2.click()

        cy.wait(3000)
        const amount=cy.get('#mat-input-34')
        amount.type(value)
       ...
       cardcity(value)
       {
        ...
        cardstate()
        {
          ...
          ck5.click()
          cy.wait(10000)
          const ck6=cy.get('#mat-option-623 > .mat-option-text')
          ck6.click()
        }
